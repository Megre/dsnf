...
from dsnf.tool.append_to_json import AppendToJson
...
class ExtractByDSNF:
    ...
    def like_noun(self, entry):
        ...
        """
        return entitytool.like_noun(entry)
    ...
    def element_connect(self, element):
        ...
        if isinstance(element, list):
            for ele in element:
                element_str += ('' if isinstance(ele, int) else ele.lemma)
        else:

...
from dsnf.core.entity_combine import EntityCombine
...
class NLP:
    ...
    """
    default_user_dict_dir = 'C:/Users/TF/PycharmProjects/PrevenRegulation/resource/'  # 默认的用户词典目录，清华大学法律词典
    default_model_dir = 'C:/Users/TF/PycharmProjects/PrevenRegulation/ltp_data_v3.4.0/'  # ltp模型文件目录
    ...
    def parse(self, words):
        ...
        for i in range(len(arcs)):
            words[i].head = arcs[i][0]
            words[i].dependency = arcs[i][1]
        # self.parser.release()
